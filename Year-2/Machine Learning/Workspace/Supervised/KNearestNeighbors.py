...
class KNN_ClassifierModel(KNeighborsClassifier):
    def __init__(self, dataframe: pd.DataFrame,
                       label_column: str,
                       n_neighbors: int,
                       algorithm: str|Literal['auto', 'ball_tree', 'kd_tree', 'brute'],
                       weights: str|Literal['uniform', 'distance'],
                       p: float,
                       random_state: int,
    ...
    def split_data(self):
        ...
        self.train_data_info = train_data_buffer.getvalue().replace("<class 'pandas.core.frame.DataFrame'>",
                                                                    "K-Neighbors Train Data Information:")
        ...
        self.test_data_info = test_data_buffer.getvalue().replace("<class 'pandas.core.frame.DataFrame'>",
                                                                  "K-Neighbors Test Data Information:")
    ...
    def plot_neighbors(self, x_ax, y_ax):
    ...
    def plot_confusion_matrix(self):
        ...
        plt.title('K-Neighbors Confusion Matrix', y=1.025)
        plt.tight_layout()
        plt.show()

class KNN_RegressorModel(KNeighborsRegressor):
    def __init__(self, dataframe: pd.DataFrame,
                       label_column: str,
                       n_neighbors: int,
                       algorithm: str|Literal['auto', 'ball_tree', 'kd_tree', 'brute'],
    ...
    def plot_regression(self):
        ...
        for i in range(len(self.y_test)):
            ax.plot([plt_range[i], plt_range[i]], [self.y_test.iloc[i, 0], self.y_pred[i, 0]], color='red')

        ax.set_title('K-Neighbors Regression', color='white', y=1.025)
