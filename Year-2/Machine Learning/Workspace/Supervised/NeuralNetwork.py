...
class NeuralNetworkModel_Classifier(MLPClassifier):
    def __init__(self, dataframe: pd.DataFrame,
                       label_column: str,
                       hidden_layer_sizes: tuple[int, ...],
                       activation: str|Literal['identity', 'logistic', 'tanh', 'relu'],
                       learning_rate: str|Literal['constant', 'invscaling', 'adaptive'],
                       solver: str|Literal['lbfgs', 'sgd', 'adam'],
                       max_iter: int,
    ...
    def split_data(self):
        ...
        self.train_data_info = train_data_buffer.getvalue().replace("<class 'pandas.core.frame.DataFrame'>",
                                                                    "Neural Network Train Data Information:")
        ...
        self.test_data_info = test_data_buffer.getvalue().replace("<class 'pandas.core.frame.DataFrame'>",
                                                                  "Neural Network Test Data Information:")
    ...
    def plot_confusion_matrix(self):
        ...
        plt.title('Neural Network Confusion Matrix', y=1.025)
        plt.tight_layout()
        plt.show()
...
class NeuralNetworkModel_Regressor(MLPRegressor):
    def __init__(self, dataframe: pd.DataFrame,
                       label_column: str,
                       hidden_layer_sizes: tuple[int, ...],
                       activation: str|Literal['identity', 'logistic', 'tanh', 'relu'],
    ...
    def plot_regression(self):
        ...
        ax.set_title('Neural Network Regression', color='white', y=1.025)
