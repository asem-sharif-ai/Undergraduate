...
class RandomForestModel_Classifier(RandomForestClassifier):
    ...
    def split_data(self):
        ...
        self.train_data_info = train_data_buffer.getvalue().replace("<class 'pandas.core.frame.DataFrame'>",
                                                                    "Random Forest Train Data Information:")
        ...
        self.test_data_info = test_data_buffer.getvalue().replace("<class 'pandas.core.frame.DataFrame'>",
                                                                  "Random Forest Test Data Information:")
    ...
    def plot_tree(self, i):
        plt.figure('Random Forest', figsize=(15, 10))
        plot_tree(self.estimators_[i], filled=True, rounded=True, feature_names=self.x_train.columns, fontsize=10)
        plt.tight_layout()
        plt.show()
    ...
    def plot_confusion_matrix(self):
        ...
        plt.title('Random Forest Confusion Matrix', y=1.025)
        plt.tight_layout()
        plt.show()

#! ----- ----- ----- ----- ----- ----- ----- ----- <<<<< Regressor >>>>> ----- ----- ----- ----- ----- ----- ----- -----

class RandomForestModel_Regressor(RandomForestRegressor):
    def __init__(self, dataframe: pd.DataFrame,
                       label_column: str,
                       n_estimators: int,
                       criterion: str|Literal['gini', 'entropy', 'log_loss'],
    ...
    def plot_regression(self):
        ...
        ax.set_title('Random Forest Regression', color='white', y=1.025)
